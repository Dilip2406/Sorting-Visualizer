...
# class to draw the required things pygame
class DrawInformation:
    ...
    def set_list(self, lst):
        ...
        # width of list/blocks should be excluding padding and dividing the width for each ITEM IN list equally
...
def draw_list(draw_info, color_positions={}, clear_bg=False):
    ...
    for i, val in enumerate(lst):
        #position(x-axis) of each list
        x = draw_info.start_x + i * draw_info.block_width

        #postion(y-axis) of each list / height of each list(where to start frm top)
...
def generate_starting_list(n, min_val, max_val):
    ...
    for _ in range(n):
        ''' take the values between smallest and largest number (INCLUDING BOTH SMALLEST AND LARGEST)'''
